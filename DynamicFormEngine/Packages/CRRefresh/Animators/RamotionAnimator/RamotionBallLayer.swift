...
class CircleLayer :CAShapeLayer, CAAnimationDelegate {
    ...
    var spiner: SpinerLayerCRRefresh?
    ...
    init(size: CGFloat, moveUpDist: CGFloat, frame: CGRect, color: UIColor = UIColor.white) {
        ...
        spiner = SpinerLayerCRRefresh(superLayerFrame: selfFrame, ballSize: size, color: color)
        super.init()
...
class SpinerLayerCRRefresh: CAShapeLayer, CAAnimationDelegate {
