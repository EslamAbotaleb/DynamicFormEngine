...
public protocol LayoutSwizzlable: NSObjectProtocol {
    func handleSwitching(forceSwitchingRegardlessOfTag: Bool)
}

public protocol Taggable: NSObjectProtocol {
    var tag: Int {get set}
}

public protocol TextAlignmented: NSObjectProtocol {
    var textAlignment: NSTextAlignment {get set}
}

extension LayoutSwizzlable where Self: TextAlignmented & Taggable {
    public func handleSwitching(forceSwitchingRegardlessOfTag: Bool) {
...
public typealias TextViewType = Taggable & LayoutSwizzlable & TextAlignmented
