...
class FileGridCell: UICollectionViewCell {
    ...
    func configure(_ file: FileModel,selectionMode: SelectionMode){
        self.fileTitle.text = file.title + "." +  file.fileExtension
        ...
        self.fileSelectedImage.isHidden = file.fileCheckbox.isAppear ? false : true
